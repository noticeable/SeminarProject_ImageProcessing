...
const char * LIB_PATH_VALUE   = "\\..\\home\\petar.nikolov\\jpeg-9a\\.\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "\\..\\home\\petar.nikolov\\jpeg-9a\\.\\.libs;C:\\msys\\1.0\\local\\lib;C:\\msys\\1.0\\local\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"jpegtran.exe:jpegtran:${LINENO}: libtool wrapper (GNU libtool) 2.4.2\"", f);
  fputs (" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"jpegtran.exe:jpegtran:${LINENO}: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
  ...
  fputs ("    PATH=/../home/petar.nikolov/jpeg-9a/./.libs:/usr/local/lib:/usr/local/bin:$", f);
  fputs ("PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/../home/petar.nikolov/jpeg-9a/./.libs:$PATH\"\n", f);
  fputs ("\n", f);
